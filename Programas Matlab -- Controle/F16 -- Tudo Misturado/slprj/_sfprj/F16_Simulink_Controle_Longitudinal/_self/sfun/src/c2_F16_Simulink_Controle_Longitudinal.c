...
static const char * c2_debug_family_names[8] = { "Kp", "Kd", "nargin", "nargout",
  "Vt", "H", "kp", "kd" };

static const char * c2_b_debug_family_names[24] = { "S", "x", "y", "x1", "x2",
  "y1", "y2", "xc", "yc", "Q11", "Q12", "Q21", "Q22", "Q", "X", "Y", "nargin",
  "nargout", "Kp", "Kd", "Vt", "H", "kp", "kd" };

/* Function Declarations */
static void initialize_c2_F16_Simulink_Controle_Longitudinal
  (SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct *chartInstance);
static void initialize_params_c2_F16_Simulink_Controle_Longitudinal
  (SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct *chartInstance);
static void enable_c2_F16_Simulink_Controle_Longitudinal
  (SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct *chartInstance);
static void disable_c2_F16_Simulink_Controle_Longitudinal
  (SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_F16_Simulink_Controle_Longitudinal
  (SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_F16_Simulink_Controle_Longitudinal
  (SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct *chartInstance);
static void set_sim_state_c2_F16_Simulink_Controle_Longitudinal
  (SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct *chartInstance, const
   mxArray *c2_st);
static void finalize_c2_F16_Simulink_Controle_Longitudinal
  (SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct *chartInstance);
static void sf_c2_F16_Simulink_Controle_Longitudinal
  (SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct *chartInstance);
static void initSimStructsc2_F16_Simulink_Controle_Longitudinal
  (SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct *chartInstance);
static void c2_CoeficientesControladores_Interpolados
  (SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct *chartInstance, real_T
   c2_Kp[99], real_T c2_Kd[99], real_T c2_Vt, real_T c2_H, real_T *c2_kp, real_T
   *c2_kd);
...
static real_T c2_c_emlrt_marshallIn
  (SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct *chartInstance, const
   mxArray *c2_kd, const char_T *c2_identifier);
...
static void c2_e_emlrt_marshallIn
  (SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct *chartInstance, const
   mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[99]);
...
static real_T c2_floor(SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct
  *chartInstance, real_T c2_x);
static void c2_inv(SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct
                   *chartInstance, real_T c2_x[4], real_T c2_y[4]);
static void c2_inv2x2(SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct
                      *chartInstance, real_T c2_x[4], real_T c2_y[4]);
static real_T c2_norm(SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct
                      *chartInstance, real_T c2_x[4]);
static void c2_eml_warning(SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct
  *chartInstance);
static void c2_b_eml_warning
  (SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct *chartInstance, char_T
   c2_varargin_2[14]);
...
static uint8_T c2_h_emlrt_marshallIn
  (SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct *chartInstance, const
   mxArray *c2_b_is_active_c2_F16_Simulink_Controle_Longitudinal, const char_T
   *c2_identifier);
static uint8_T c2_i_emlrt_marshallIn
  (SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct *chartInstance, const
   mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_floor(SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct
  *chartInstance, real_T *c2_x);
  ...
  (SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_F16_Simulink_Controle_Longitudinal = 0U;
}
  ...
  (SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct *chartInstance)
{
  ...
  real_T *c2_kd;
  real_T *c2_kp;
  c2_kd = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c2_kp = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c2_st = NULL;
  c2_st = NULL;
  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_createcellarray(3), FALSE);
  c2_hoistedGlobal = *c2_kd;
  c2_u = c2_hoistedGlobal;
  c2_b_y = NULL;
  sf_mex_assign(&c2_b_y, sf_mex_create("y", &c2_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_setcell(c2_y, 0, c2_b_y);
  c2_b_hoistedGlobal = *c2_kp;
  c2_b_u = c2_b_hoistedGlobal;
  c2_c_y = NULL;
  sf_mex_assign(&c2_c_y, sf_mex_create("y", &c2_b_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_setcell(c2_y, 1, c2_c_y);
  c2_c_hoistedGlobal =
    chartInstance->c2_is_active_c2_F16_Simulink_Controle_Longitudinal;
   ...
   mxArray *c2_st)
{
  ...
  *c2_kd = c2_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u,
    0)), "kd");
  *c2_kp = c2_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u,
    1)), "kp");
  chartInstance->c2_is_active_c2_F16_Simulink_Controle_Longitudinal =
    c2_h_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
    "is_active_c2_F16_Simulink_Controle_Longitudinal");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_F16_Simulink_Controle_Longitudinal(chartInstance);
  ...
  (SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct *chartInstance)
{
  ...
  int32_T c2_i0;
  int32_T c2_i1;
  static real_T c2_dv0[99] = { -50.0, -50.0, -50.0, -50.0, -50.0, -50.0, -50.0,
    -50.0, -50.0, -49.7093, -49.8079, -23.8542, -23.9413, -24.0278, -50.0, -50.0,
    -50.0, -50.0, -21.7601, -21.8419, -21.9235, -22.0316, -22.1114, -22.1709,
    -22.2762, -22.3598, -22.4197, -20.7539, -20.8417, -20.9294, -21.0166,
    -21.1061, -21.1782, -21.2641, -21.3662, -21.4389, -19.5642, -19.6596,
    -19.7548, -19.8499, -19.9448, -20.0304, -20.1342, -21.0837, -21.1824,
    -18.2822, -18.3832, -18.4774, -18.5848, -18.6856, -18.78, -18.8788, -18.9792,
    -19.0821, -21.1135, -21.2586, -21.3813, -21.5053, -21.6212, -21.7502,
    -21.8793, -22.005, -22.1309, -19.7012, -19.8178, -19.9338, -20.0564,
    -20.1667, -20.288, -20.4059, -20.5236, -20.6425, -18.4624, -18.567, -18.6713,
    -18.7843, -18.8945, -19.0049, -19.1191, -19.2316, -19.3448, -17.3919,
    -17.4888, -17.592, -17.6909, -17.794, -17.8966, -17.9992, -18.1052, -18.2075,
    -16.4628, -16.5541, -16.6511, -16.7426, -16.8375, -16.9321, -17.0252,
    -17.1261, -17.2247 };
  ...
  c2_b_Vt = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  c2_c_kd = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c2_c_kp = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 0U, chartInstance->c2_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c2_c_kp, 0U);
  _SFD_DATA_RANGE_CHECK(*c2_c_kd, 1U);
  _SFD_DATA_RANGE_CHECK(*c2_b_Vt, 2U);
  _SFD_DATA_RANGE_CHECK(*c2_b_H, 3U);
  chartInstance->c2_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 0U, chartInstance->c2_sfEvent);
  c2_hoistedGlobal = *c2_b_Vt;
  c2_b_hoistedGlobal = *c2_b_H;
  c2_Vt = c2_hoistedGlobal;
  c2_H = c2_b_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 8U, 8U, c2_debug_family_names,
    c2_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_Kp, 0U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_Kd, 1U, c2_b_sf_marshallOut);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 3U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_Vt, 4U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_H, 5U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_kp, 6U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_kd, 7U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 3);
  for (c2_i0 = 0; c2_i0 < 99; c2_i0++) {
    c2_Kp[c2_i0] = -50.0;
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 13);
  for (c2_i1 = 0; c2_i1 < 99; c2_i1++) {
    c2_Kd[c2_i1] = c2_dv0[c2_i1];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 24);
  for (c2_i2 = 0; c2_i2 < 99; c2_i2++) {
    c2_dv1[c2_i2] = -50.0;
  }

  for (c2_i3 = 0; c2_i3 < 99; c2_i3++) {
    c2_dv2[c2_i3] = c2_dv0[c2_i3];
  }

  c2_CoeficientesControladores_Interpolados(chartInstance, c2_dv1, c2_dv2, 440.0,
    1200.0, &c2_b_kp, &c2_b_kd);
  c2_kp = c2_b_kp;
  c2_kd = c2_b_kd;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, -24);
   ...
   *c2_kd)
{
  ...
  int32_T c2_c_k;
  int32_T c2_d_k;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 24U, 24U, c2_b_debug_family_names,
    c2_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_S, 0U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_y, 2U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_x1, 3U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_x2, 4U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_y2, 6U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_xc, 7U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_yc, 8U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_Q11, 9U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_Q12, 10U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_Q21, 11U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_Q22, 12U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_Q, 13U, c2_c_sf_marshallOut,
    c2_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_X, 14U, c2_c_sf_marshallOut,
    c2_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_Y, 15U, c2_c_sf_marshallOut,
    c2_c_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 17U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_Kp, 18U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_Kd, 19U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_Vt, 20U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_H, 21U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_kp, 22U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_kd, 23U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_SCRIPT_FCN(0, 0);
  ...
  c2_Q11 = c2_Kp[((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("Kp", (int32_T)
    _SFD_INTEGER_CHECK("yc", c2_yc), 1, 9, 1, 0) + 9 * ((int32_T)(real_T)
    _SFD_EML_ARRAY_BOUNDS_CHECK("Kp", (int32_T)_SFD_INTEGER_CHECK("xc", c2_xc),
    1, 11, 2, 0) - 1)) - 1];
  _SFD_SCRIPT_CALL(0U, chartInstance->c2_sfEvent, 63);
  c2_Q12 = c2_Kp[((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("Kp", (int32_T)
    _SFD_INTEGER_CHECK("yc+1", c2_yc + 1.0), 1, 9, 1, 0) + 9 * ((int32_T)(real_T)
    _SFD_EML_ARRAY_BOUNDS_CHECK("Kp", (int32_T)_SFD_INTEGER_CHECK("xc", c2_xc),
    1, 11, 2, 0) - 1)) - 1];
  _SFD_SCRIPT_CALL(0U, chartInstance->c2_sfEvent, 64);
  c2_Q21 = c2_Kp[((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("Kp", (int32_T)
    _SFD_INTEGER_CHECK("yc", c2_yc), 1, 9, 1, 0) + 9 * ((int32_T)(real_T)
    _SFD_EML_ARRAY_BOUNDS_CHECK("Kp", (int32_T)_SFD_INTEGER_CHECK("xc+1", c2_xc
    + 1.0), 1, 11, 2, 0) - 1)) - 1];
  _SFD_SCRIPT_CALL(0U, chartInstance->c2_sfEvent, 65);
  c2_Q22 = c2_Kp[((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("Kp", (int32_T)
    _SFD_INTEGER_CHECK("yc+1", c2_yc + 1.0), 1, 9, 1, 0) + 9 * ((int32_T)(real_T)
    _SFD_EML_ARRAY_BOUNDS_CHECK("Kp", (int32_T)_SFD_INTEGER_CHECK("xc+1", c2_xc
    + 1.0), 1, 11, 2, 0) - 1)) - 1];
  ...
  c2_inv(chartInstance, c2_b_Y, c2_e_b);
  ...
  for (c2_i6 = 0; c2_i6 < 2; c2_i6++) {
    ...
    for (c2_i7 = 0; c2_i7 < 2; c2_i7++) {
      c2_f_y[c2_i6] += c2_a[c2_i7] * c2_e_b[c2_i7 + c2_i5];
    }
  ...
  for (c2_i9 = 0; c2_i9 < 2; c2_i9++) {
    ...
    for (c2_i11 = 0; c2_i11 < 2; c2_i11++) {
      c2_e_b[c2_i11 + c2_i8] = c2_Q[c2_i10 + c2_i9];
      c2_i10 += 2;
    }
  ...
  for (c2_i13 = 0; c2_i13 < 2; c2_i13++) {
    ...
    for (c2_i14 = 0; c2_i14 < 2; c2_i14++) {
      c2_a[c2_i13] += c2_f_y[c2_i14] * c2_e_b[c2_i14 + c2_i12];
    }
  ...
  c2_inv(chartInstance, c2_b_X, c2_dv3);
  c2_i16 = 0;
  for (c2_i17 = 0; c2_i17 < 2; c2_i17++) {
    c2_i18 = 0;
    for (c2_i19 = 0; c2_i19 < 2; c2_i19++) {
      c2_e_b[c2_i19 + c2_i16] = c2_dv3[c2_i18 + c2_i17];
      c2_i18 += 2;
    }
  ...
  for (c2_i21 = 0; c2_i21 < 2; c2_i21++) {
    ...
    for (c2_i22 = 0; c2_i22 < 2; c2_i22++) {
      c2_f_y[c2_i21] += c2_a[c2_i22] * c2_e_b[c2_i22 + c2_i20];
    }
  ...
  *c2_kp = 0.0;
  for (c2_k = 1; c2_k < 3; c2_k++) {
    c2_b_k = c2_k;
    *c2_kp += c2_f_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
      ("", (real_T)c2_b_k), 1, 2, 1, 0) - 1] *
      c2_f_b[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      (real_T)c2_b_k), 1, 2, 1, 0) - 1];
  }

  _SFD_SCRIPT_CALL(0U, chartInstance->c2_sfEvent, 80);
  c2_Q11 = c2_Kd[((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("Kd", (int32_T)
    _SFD_INTEGER_CHECK("yc", c2_yc), 1, 9, 1, 0) + 9 * ((int32_T)(real_T)
    _SFD_EML_ARRAY_BOUNDS_CHECK("Kd", (int32_T)_SFD_INTEGER_CHECK("xc", c2_xc),
    1, 11, 2, 0) - 1)) - 1];
  _SFD_SCRIPT_CALL(0U, chartInstance->c2_sfEvent, 81);
  c2_Q12 = c2_Kd[((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("Kd", (int32_T)
    _SFD_INTEGER_CHECK("yc+1", c2_yc + 1.0), 1, 9, 1, 0) + 9 * ((int32_T)(real_T)
    _SFD_EML_ARRAY_BOUNDS_CHECK("Kd", (int32_T)_SFD_INTEGER_CHECK("xc", c2_xc),
    1, 11, 2, 0) - 1)) - 1];
  _SFD_SCRIPT_CALL(0U, chartInstance->c2_sfEvent, 82);
  c2_Q21 = c2_Kd[((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("Kd", (int32_T)
    _SFD_INTEGER_CHECK("yc", c2_yc), 1, 9, 1, 0) + 9 * ((int32_T)(real_T)
    _SFD_EML_ARRAY_BOUNDS_CHECK("Kd", (int32_T)_SFD_INTEGER_CHECK("xc+1", c2_xc
    + 1.0), 1, 11, 2, 0) - 1)) - 1];
  _SFD_SCRIPT_CALL(0U, chartInstance->c2_sfEvent, 83);
  c2_Q22 = c2_Kd[((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("Kd", (int32_T)
    _SFD_INTEGER_CHECK("yc+1", c2_yc + 1.0), 1, 9, 1, 0) + 9 * ((int32_T)(real_T)
    _SFD_EML_ARRAY_BOUNDS_CHECK("Kd", (int32_T)_SFD_INTEGER_CHECK("xc+1", c2_xc
    + 1.0), 1, 11, 2, 0) - 1)) - 1];
  _SFD_SCRIPT_CALL(0U, chartInstance->c2_sfEvent, 84);
  c2_Q[0] = c2_Q11;
  c2_Q[2] = c2_Q12;
  c2_Q[1] = c2_Q21;
  c2_Q[3] = c2_Q22;
  ...
  for (c2_i24 = 0; c2_i24 < 4; c2_i24++) {
    c2_c_Y[c2_i24] = c2_Y[c2_i24];
  }

  c2_inv(chartInstance, c2_c_Y, c2_e_b);
  c2_eml_scalar_eg(chartInstance);
  c2_eml_scalar_eg(chartInstance);
  c2_i25 = 0;
  for (c2_i26 = 0; c2_i26 < 2; c2_i26++) {
    ...
    for (c2_i27 = 0; c2_i27 < 2; c2_i27++) {
      c2_f_y[c2_i26] += c2_a[c2_i27] * c2_e_b[c2_i27 + c2_i25];
    }
  ...
  for (c2_i29 = 0; c2_i29 < 2; c2_i29++) {
    ...
    for (c2_i31 = 0; c2_i31 < 2; c2_i31++) {
      c2_e_b[c2_i31 + c2_i28] = c2_Q[c2_i30 + c2_i29];
      c2_i30 += 2;
    }
  ...
  for (c2_i33 = 0; c2_i33 < 2; c2_i33++) {
    ...
    for (c2_i34 = 0; c2_i34 < 2; c2_i34++) {
      c2_a[c2_i33] += c2_f_y[c2_i34] * c2_e_b[c2_i34 + c2_i32];
    }
  ...
  for (c2_i35 = 0; c2_i35 < 4; c2_i35++) {
    c2_c_X[c2_i35] = c2_X[c2_i35];
  }

  c2_inv(chartInstance, c2_c_X, c2_dv3);
  c2_i36 = 0;
  for (c2_i37 = 0; c2_i37 < 2; c2_i37++) {
    c2_i38 = 0;
    for (c2_i39 = 0; c2_i39 < 2; c2_i39++) {
      c2_e_b[c2_i39 + c2_i36] = c2_dv3[c2_i38 + c2_i37];
      c2_i38 += 2;
    }
  ...
  for (c2_i41 = 0; c2_i41 < 2; c2_i41++) {
    ...
    for (c2_i42 = 0; c2_i42 < 2; c2_i42++) {
      c2_f_y[c2_i41] += c2_a[c2_i42] * c2_e_b[c2_i42 + c2_i40];
    }
  ...
  *c2_kd = 0.0;
  for (c2_c_k = 1; c2_c_k < 3; c2_c_k++) {
    c2_d_k = c2_c_k;
    *c2_kd += c2_f_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
  ...
  c2_chartNumber)
{
  _SFD_SCRIPT_TRANSLATION(c2_chartNumber, 0U, sf_debug_get_script_id(
    "C:/Users/Eduardo/Desktop/Eduardo/M\xedssil AV-TM 300/Programas Matlab/F16 -- Tudo Misturado/CoeficientesControladores_Interpolados.m"));
}
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct *chartInstance;
  chartInstance = (SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct *)
    chartInstanceVoid;
   ...
   mxArray *c2_kd, const char_T *c2_identifier)
{
  ...
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_y = c2_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_kd), &c2_thisId);
  ...
  *c2_inData)
{
  ...
  for (c2_i46 = 0; c2_i46 < 11; c2_i46++) {
    for (c2_i47 = 0; c2_i47 < 9; c2_i47++) {
      c2_b_inData[c2_i47 + c2_i45] = (*(real_T (*)[99])c2_inData)[c2_i47 +
        c2_i45];
    }
  ...
  for (c2_i49 = 0; c2_i49 < 11; c2_i49++) {
    for (c2_i50 = 0; c2_i50 < 9; c2_i50++) {
      c2_u[c2_i50 + c2_i48] = c2_b_inData[c2_i50 + c2_i48];
    }
  ...
  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_create("y", c2_u, 0, 0U, 1U, 0U, 2, 9, 11), FALSE);
  sf_mex_assign(&c2_mxArrayOutData, c2_y, FALSE);
  return c2_mxArrayOutData;
}
   ...
   mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[99])
{
  real_T c2_dv4[99];
  int32_T c2_i51;
  sf_mex_import(c2_parentId, sf_mex_dup(c2_u), c2_dv4, 1, 0, 0U, 1, 0U, 2, 9, 11);
  for (c2_i51 = 0; c2_i51 < 99; c2_i51++) {
    c2_y[c2_i51] = c2_dv4[c2_i51];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  for (c2_i53 = 0; c2_i53 < 11; c2_i53++) {
    for (c2_i54 = 0; c2_i54 < 9; c2_i54++) {
      (*(real_T (*)[99])c2_outData)[c2_i54 + c2_i52] = c2_y[c2_i54 + c2_i52];
    }
  ...
  *c2_inData)
{
  ...
  for (c2_i56 = 0; c2_i56 < 2; c2_i56++) {
    for (c2_i57 = 0; c2_i57 < 2; c2_i57++) {
      c2_b_inData[c2_i57 + c2_i55] = (*(real_T (*)[4])c2_inData)[c2_i57 + c2_i55];
    }
   ...
   mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[4])
{
  real_T c2_dv5[4];
  int32_T c2_i61;
  sf_mex_import(c2_parentId, sf_mex_dup(c2_u), c2_dv5, 1, 0, 0U, 1, 0U, 2, 2, 2);
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_f_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_Y), &c2_thisId, c2_y);
  sf_mex_destroy(&c2_Y);
  c2_i62 = 0;
  for (c2_i63 = 0; c2_i63 < 2; c2_i63++) {
    for (c2_i64 = 0; c2_i64 < 2; c2_i64++) {
      (*(real_T (*)[4])c2_outData)[c2_i64 + c2_i62] = c2_y[c2_i64 + c2_i62];
    }
...
const mxArray
  *sf_c2_F16_Simulink_Controle_Longitudinal_get_eml_resolved_functions_info(void)
{
...
static void c2_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "CoeficientesControladores_Interpolados"), "name", "name", 0);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 0);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[EW]C:/Users/Eduardo/Desktop/Eduardo/M\\xc3\\xadssil AV-TM 300/Programas Matlab/F16 -- Tudo Misturado/CoeficientesControladores_In"
    "terpolados.m"), "resolved", "resolved", 0);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1507641589U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[EW]C:/Users/Eduardo/Desktop/Eduardo/M\\xc3\\xadssil AV-TM 300/Programas Matlab/F16 -- Tudo Misturado/CoeficientesControladores_In"
    "terpolados.m"), "context", "context", 1);
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[EW]C:/Users/Eduardo/Desktop/Eduardo/M\\xc3\\xadssil AV-TM 300/Programas Matlab/F16 -- Tudo Misturado/CoeficientesControladores_In"
    "terpolados.m"), "context", "context", 6);
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[EW]C:/Users/Eduardo/Desktop/Eduardo/M\\xc3\\xadssil AV-TM 300/Programas Matlab/F16 -- Tudo Misturado/CoeficientesControladores_In"
    "terpolados.m"), "context", "context", 9);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("mtimes"), "name", "name", 9);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 9);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[EW]C:/Users/Eduardo/Desktop/Eduardo/M\\xc3\\xadssil AV-TM 300/Programas Matlab/F16 -- Tudo Misturado/CoeficientesControladores_In"
    "terpolados.m"), "context", "context", 11);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("inv"), "name", "name", 11);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 11);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/inv.m"), "resolved",
                  "resolved", 11);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1305336000U), "fileTimeLo",
                  "fileTimeLo", 11);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 11);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1286836706U), "fileTimeLo",
                  "fileTimeLo", 12);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 12);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/inv.m!checkcond"),
                  "context", "context", 18);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("norm"), "name", "name", 18);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 18);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/norm.m"), "resolved",
                  "resolved", 18);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1363728268U), "fileTimeLo",
                  "fileTimeLo", 18);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 18);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m"), "resolved",
                  "resolved", 21);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1363728258U), "fileTimeLo",
                  "fileTimeLo", 21);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 21);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1286836776U), "fileTimeLo",
                  "fileTimeLo", 23);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 23);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1286836782U), "fileTimeLo",
                  "fileTimeLo", 24);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 24);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_warning.m"), "resolved",
                  "resolved", 26);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1286836802U), "fileTimeLo",
                  "fileTimeLo", 26);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 26);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m"), "resolved",
                  "resolved", 28);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1326738796U), "fileTimeLo",
                  "fileTimeLo", 28);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 28);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_flt2str.m"), "resolved",
                  "resolved", 32);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1360293150U), "fileTimeLo",
                  "fileTimeLo", 32);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 32);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/strfun/char.m"), "resolved",
                  "resolved", 33);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1319744368U), "fileTimeLo",
                  "fileTimeLo", 33);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 33);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1363728270U), "fileTimeLo",
                  "fileTimeLo", 36);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 36);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1299091168U), "fileTimeLo",
                  "fileTimeLo", 37);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 37);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemm.m!below_threshold"),
                  "context", "context", 38);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("mtimes"), "name", "name", 38);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 38);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m"), "resolved",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xdotu.m"), "context",
                  "context", 44);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("eml_xdot"), "name", "name", 44);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 44);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1299091172U), "fileTimeLo",
                  "fileTimeLo", 47);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 47);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1286836778U), "fileTimeLo",
                  "fileTimeLo", 51);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 51);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1286836780U), "fileTimeLo",
                  "fileTimeLo", 53);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 53);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1346528340U), "fileTimeLo",
                  "fileTimeLo", 57);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 57);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  if (c2_n1x == 0.0) {
    ...
    if (guard3 == TRUE) {
      ...
      sf_mex_assign(&c2_g_y, sf_mex_create("y", &c2_d_u, 0, 0U, 0U, 0U, 0),
                    FALSE);
      c2_emlrt_marshallIn(chartInstance, sf_mex_call_debug("sprintf", 1U, 2U, 14,
        sf_mex_call_debug("sprintf", 1U, 3U, 14, c2_d_y, 14, c2_e_y, 14, c2_f_y),
        14, c2_g_y), "sprintf", c2_str);
      for (c2_i69 = 0; c2_i69 < 14; c2_i69++) {
        c2_b_str[c2_i69] = c2_str[c2_i69];
      }
   ...
   c2_varargin_2[14])
{
  ...
  char_T c2_b_u[14];
  const mxArray *c2_b_y = NULL;
  for (c2_i71 = 0; c2_i71 < 33; c2_i71++) {
    c2_u[c2_i71] = c2_varargin_1[c2_i71];
  }

  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_create("y", c2_u, 10, 0U, 1U, 0U, 2, 1, 33), FALSE);
  for (c2_i72 = 0; c2_i72 < 14; c2_i72++) {
    c2_b_u[c2_i72] = c2_varargin_2[c2_i72];
  }
   ...
   mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId)
{
  int32_T c2_y;
  int32_T c2_i73;
  sf_mex_import(c2_parentId, sf_mex_dup(c2_u), &c2_i73, 1, 6, 0U, 0, 0U, 0);
  c2_y = c2_i73;
  sf_mex_destroy(&c2_u);
  return c2_y;
}
   ...
   *c2_identifier)
{
  ...
  c2_y = c2_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_F16_Simulink_Controle_Longitudinal), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_F16_Simulink_Controle_Longitudinal);
  return c2_y;
}
...
void sf_c2_F16_Simulink_Controle_Longitudinal_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4109675147U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(887166443U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(178818468U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1012586778U);
}

mxArray *sf_c2_F16_Simulink_Controle_Longitudinal_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("u9CZrFGUurgtLxqPMRzbSF");
...
mxArray *sf_c2_F16_Simulink_Controle_Longitudinal_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_F16_Simulink_Controle_Longitudinal_updateBuildInfo_args_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c2_F16_Simulink_Controle_Longitudinal(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[7],T\"kd\",},{M[1],M[5],T\"kp\",},{M[8],M[0],T\"is_active_c2_F16_Simulink_Controle_Longitudinal\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_F16_Simulink_Controle_Longitudinal_get_check_sum(&mxChecksum);
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,2,0,1,"kp");
          _SFD_SET_DATA_PROPS(1,2,0,1,"kd");
          _SFD_SET_DATA_PROPS(2,1,1,0,"Vt");
          _SFD_SET_DATA_PROPS(3,1,1,0,"H");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1811);
        _SFD_CV_INIT_SCRIPT(0,1,4,0,0,0,0,0,0,0);
        _SFD_CV_INIT_SCRIPT_FCN(0,0,"CoeficientesControladores_Interpolados",0,
          -1,2064);
        _SFD_CV_INIT_SCRIPT_IF(0,0,1253,1263,-1,1278);
        _SFD_CV_INIT_SCRIPT_IF(0,1,1279,1290,-1,1306);
        _SFD_CV_INIT_SCRIPT_IF(0,2,1363,1373,-1,1388);
        _SFD_CV_INIT_SCRIPT_IF(0,3,1389,1399,-1,1414);
...

        {
          ...
          c2_Vt = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          c2_kd = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
          c2_kp = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          _SFD_SET_DATA_VALUE_PTR(0U, c2_kp);
          _SFD_SET_DATA_VALUE_PTR(1U, c2_kd);
          _SFD_SET_DATA_VALUE_PTR(2U, c2_Vt);
          _SFD_SET_DATA_VALUE_PTR(3U, c2_H);
        }
      }
    } else {
...
{
  return "kiP9mgL3eYSaaR44oTIIgH";
}

static void sf_opaque_initialize_c2_F16_Simulink_Controle_Longitudinal(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c2_F16_Simulink_Controle_Longitudinal
    ((SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct*) chartInstanceVar);
  initialize_c2_F16_Simulink_Controle_Longitudinal
    ((SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_F16_Simulink_Controle_Longitudinal(void
  *chartInstanceVar)
{
  enable_c2_F16_Simulink_Controle_Longitudinal
    ((SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_F16_Simulink_Controle_Longitudinal(void
  *chartInstanceVar)
{
  disable_c2_F16_Simulink_Controle_Longitudinal
    ((SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_F16_Simulink_Controle_Longitudinal(void
  *chartInstanceVar)
{
  sf_c2_F16_Simulink_Controle_Longitudinal
    ((SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c2_F16_Simulink_Controle_Longitudinal(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_F16_Simulink_Controle_Longitudinal
    ((SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c2_F16_Simulink_Controle_Longitudinal();/* state var info */
...
extern void sf_internal_set_sim_state_c2_F16_Simulink_Controle_Longitudinal
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c2_F16_Simulink_Controle_Longitudinal
    ((SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c2_F16_Simulink_Controle_Longitudinal(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_F16_Simulink_Controle_Longitudinal(S);
}

static void sf_opaque_set_sim_state_c2_F16_Simulink_Controle_Longitudinal
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_F16_Simulink_Controle_Longitudinal(S, st);
}

static void sf_opaque_terminate_c2_F16_Simulink_Controle_Longitudinal(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_F16_Simulink_Controle_Longitudinal_optimization_info();
    }

    finalize_c2_F16_Simulink_Controle_Longitudinal
      ((SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_F16_Simulink_Controle_Longitudinal
    ((SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_F16_Simulink_Controle_Longitudinal(SimStruct
  *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_F16_Simulink_Controle_Longitudinal(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
      load_F16_Simulink_Controle_Longitudinal_optimization_info();
  ...
  ssSetChecksum0(S,(411503186U));
  ssSetChecksum1(S,(79425531U));
  ssSetChecksum2(S,(2055347169U));
  ssSetChecksum3(S,(347912861U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_F16_Simulink_Controle_Longitudinal(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_F16_Simulink_Controle_Longitudinal(SimStruct *S)
{
  SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct *chartInstance;
  chartInstance = (SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct *)
    utMalloc(sizeof(SFc2_F16_Simulink_Controle_LongitudinalInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_F16_Simulink_Controle_Longitudinal;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_F16_Simulink_Controle_Longitudinal;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_F16_Simulink_Controle_Longitudinal;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_F16_Simulink_Controle_Longitudinal;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_F16_Simulink_Controle_Longitudinal;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_F16_Simulink_Controle_Longitudinal;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_F16_Simulink_Controle_Longitudinal;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_F16_Simulink_Controle_Longitudinal;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_F16_Simulink_Controle_Longitudinal;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c2_F16_Simulink_Controle_Longitudinal;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_F16_Simulink_Controle_Longitudinal;
...
void c2_F16_Simulink_Controle_Longitudinal_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_F16_Simulink_Controle_Longitudinal(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_F16_Simulink_Controle_Longitudinal(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_F16_Simulink_Controle_Longitudinal(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_F16_Simulink_Controle_Longitudinal_method_dispatcher.\n"
