...
{
  extern unsigned int
    sf_F16_Simulink_Controle_Longitudinal_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_F16_Simulink_Controle_Longitudinal_process_check_sum_call(nlhs,plhs,
       nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_F16_Simulink_Controle_Longitudinal_autoinheritance_info
  ...
  if (strcmp(machineName, "F16_Simulink_Controle_Longitudinal") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_F16_Simulink_Controle_Longitudinal_autoinheritance_info(nlhs,plhs,
      3,newRhs);
  }
...
{
  extern unsigned int
    sf_F16_Simulink_Controle_Longitudinal_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "F16_Simulink_Controle_Longitudinal") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_F16_Simulink_Controle_Longitudinal_third_party_uses_info(nlhs,plhs,
      3,newRhs);
  }
...
{
  extern unsigned int
    sf_F16_Simulink_Controle_Longitudinal_updateBuildInfo_args_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "F16_Simulink_Controle_Longitudinal") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_F16_Simulink_Controle_Longitudinal_updateBuildInfo_args_info(nlhs,
      plhs,3,newRhs);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "F16_Simulink_Controle_Longitudinal") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_F16_Simulink_Controle_Longitudinal_get_eml_resolved_functions_info
      (nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_F16_Simulink_Controle_Longitudinal_method_dispatcher
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"F16_Simulink_Controle_Longitudinal")) {
    return(sf_F16_Simulink_Controle_Longitudinal_method_dispatcher(simstructPtr,
...
extern void F16_Simulink_Controle_Longitudinal_terminator(void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    F16_Simulink_Controle_Longitudinal_terminator();
...
extern void F16_Simulink_Controle_Longitudinal_initializer(void);
extern void F16_Simulink_Controle_Longitudinal_register_exported_symbols
  (SimStruct* S);
extern void F16_Simulink_Controle_Longitudinal_debug_initialize(struct
  SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  F16_Simulink_Controle_Longitudinal_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      F16_Simulink_Controle_Longitudinal_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    F16_Simulink_Controle_Longitudinal_initializer();
  }
