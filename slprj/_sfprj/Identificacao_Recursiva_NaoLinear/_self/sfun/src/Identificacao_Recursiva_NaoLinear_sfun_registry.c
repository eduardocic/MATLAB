...
{
  extern unsigned int
    sf_Identificacao_Recursiva_NaoLinear_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Identificacao_Recursiva_NaoLinear_process_check_sum_call(nlhs,plhs,nrhs,
       prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_Identificacao_Recursiva_NaoLinear_autoinheritance_info(
  ...
  if (strcmp(machineName, "Identificacao_Recursiva_NaoLinear") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Identificacao_Recursiva_NaoLinear_autoinheritance_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int sf_Identificacao_Recursiva_NaoLinear_third_party_uses_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "Identificacao_Recursiva_NaoLinear") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Identificacao_Recursiva_NaoLinear_third_party_uses_info(nlhs,plhs,
      3,newRhs);
  }
...
{
  extern unsigned int
    sf_Identificacao_Recursiva_NaoLinear_updateBuildInfo_args_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "Identificacao_Recursiva_NaoLinear") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Identificacao_Recursiva_NaoLinear_updateBuildInfo_args_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_Identificacao_Recursiva_NaoLinear_get_eml_resolved_functions_info( int
  ...
  if (strcmp(machineName, "Identificacao_Recursiva_NaoLinear") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_Identificacao_Recursiva_NaoLinear_get_eml_resolved_functions_info
      (nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_Identificacao_Recursiva_NaoLinear_method_dispatcher
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"Identificacao_Recursiva_NaoLinear")) {
    return(sf_Identificacao_Recursiva_NaoLinear_method_dispatcher(simstructPtr,
...
void sf_machine_global_terminator(void)
{
  ...
  if (sfGlobalMdlStartCallCounts == 0) {
    Identificacao_Recursiva_NaoLinear_terminator();
...
extern void Identificacao_Recursiva_NaoLinear_register_exported_symbols
  (SimStruct* S);
extern void Identificacao_Recursiva_NaoLinear_debug_initialize(struct
  SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  Identificacao_Recursiva_NaoLinear_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      Identificacao_Recursiva_NaoLinear_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    Identificacao_Recursiva_NaoLinear_initializer();
  }
