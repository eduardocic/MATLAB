function [sys, past_x0, str, ts] = LMI_XComRestricao(t, past_x, inputs, flag, A, B, Umax, rho, T)
...
[Xnovo, m5, sXnovo] = lmivar(2,[n 1]);     % X (nx1) simétrica full-block.
...
lmiterm([-LMI_Kothare 1 2 Xnovo],1,-1);  % Direita da LMI(-), pos (1,2), -Xnovo.
...
lmiterm([-LMIss 1 2 Xnovo],1,1);     % Direita da LMI(-), pos (1,2), -Hz.
...
Xnovo = dec2mat(SistemaLMIs, Xopt, Xnovo);
