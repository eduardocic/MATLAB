###########################################################################
## Makefile generated for Simulink model 'G'. 
## 
## Makefile     : G.mk
## Generated on : Wed Dec 20 13:10:04 2017
## MATLAB Coder version: 2.5 (R2013b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/G.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/Eduardo/Documents/MATLAB/Teste
ARCH                      = win32
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = C89/C90 (ANSI)
MODELREF_LINK_RSPFILE_NAME = G_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = G_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/G.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR)/G_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=G -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/G_ert_rtw/G.c $(START_DIR)/G_ert_rtw/G_data.c
