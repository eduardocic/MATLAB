...
xk = inputs(1:end-2);               % Estado medido x(k)
XssIntermed = inputs(end-1:end);    % Xss;
...
% if t>=1
% LMI_Kothare2 = newlmi;
% lmiterm([-LMI_Kothare2 1 1 Q],1,1);           % Direita da LMI(-), pos (1,1), Var (Q).
% lmiterm([-LMI_Kothare2 1 2 0],xk);            % Direita da LMI(-), pos (1,2), Const (x(k)).
% lmiterm([-LMI_Kothare2 1 2 0],-XssIntermed);  % Direita da LMI(-), pos (1,2), Const (x(k)).
% lmiterm([-LMI_Kothare2 2 2 0],1);             % Direita da LMI(-), pos (1,2), Const '1'
% end
