...
% xk = [-10; 10];    % Não factível
% xk = [-15; 15];    % Não factível
% xk = [6; 20];      % Não factível
% xk = [20; 20];     % Factível
% xk = [30; 30];     % Factível
% xk = [35; 35];     % Factível
% xk = [40; 40];     % Factível
...
% xk = [20; 6];        % Não-Factível
% xk = [20; 0];        % Não-Factível
% xk = [30; 0];        % Não-Factível

xk = [20; -5];        % Não-Factível
% xk = [20; -4];        % Não-Factível

% xk = [-6; -20];         % Não-Factível

% xk = [-10; -30];        % Não-Factível
