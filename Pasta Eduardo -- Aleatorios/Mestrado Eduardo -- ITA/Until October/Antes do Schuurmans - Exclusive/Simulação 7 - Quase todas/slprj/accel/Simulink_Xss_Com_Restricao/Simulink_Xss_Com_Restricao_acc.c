...
mdlInitializeSizes ( SimStruct * S ) { ssSetChecksumVal ( S , 0 , 1701066689U
) ; ssSetChecksumVal ( S , 1 , 734843799U ) ; ssSetChecksumVal ( S , 2 ,
1687851634U ) ; ssSetChecksumVal ( S , 3 , 3527798671U ) ; { mxArray *
