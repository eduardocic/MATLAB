###########################################################################
## Makefile generated for MATLAB file/project 'soma'. 
## 
## Makefile     : soma_rtw.mk
## Generated on : Wed Jan 31 16:41:52 2018
## MATLAB Coder version: 2.5 (R2013b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/soma.lib
...
MATLAB_ARCH_BIN           = C:/Program Files/MATLAB/R2013b/bin/win32
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/Eduardo/DOCUME~1/MATLAB/GERAND~1
ARCH                      = win32
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/soma.lib
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/codegen/lib/soma -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=soma -DHAVESTDIO -DUSE_RTMODEL
...
SRCS = $(START_DIR)/codegen/lib/soma/soma_initialize.c $(START_DIR)/codegen/lib/soma/soma_terminate.c $(START_DIR)/codegen/lib/soma/soma.c $(START_DIR)/codegen/lib/soma/rt_nonfinite.c $(START_DIR)/codegen/lib/soma/rtGetNaN.c $(START_DIR)/codegen/lib/soma/rtGetInf.c
...
OBJS = soma_initialize.obj soma_terminate.obj soma.obj rt_nonfinite.obj rtGetNaN.obj rtGetInf.obj
...
%.obj : $(START_DIR)/codegen/lib/soma/%.c
	$(CC) $(CFLAGS) -Fo"$@" "$<"
