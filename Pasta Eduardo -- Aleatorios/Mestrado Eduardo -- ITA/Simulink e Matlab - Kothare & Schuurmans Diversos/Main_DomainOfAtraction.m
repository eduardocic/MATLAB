...
DomainKothare = DirectionDomainOfAtractionKothare(A, B, Umax, 1800);

% 4.: Plota a Região do Domínio de Atração.
PlotDomainOfAtractionKothare(DomainKothare);        % Visualiza o Domínio de Atração.

% 5.: Salva os valores dos vetores do Domínio de Atração.
save('DomainKothare.mat','DomainKothare');
